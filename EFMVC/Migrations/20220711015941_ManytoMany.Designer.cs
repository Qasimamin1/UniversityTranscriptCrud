...
namespace EFMVC.Migrations
{
    ...
    [Migration("20220711015941_ManytoMany")]
            ...
            modelBuilder.Entity("SubjectTeacher", b =>
                {
                    ...
                    b.Property<int>("TeachersSubjectsSubjectId")
                        .HasColumnType("int");

                    b.HasKey("SubjectTeachersTeacherId", "TeachersSubjectsSubjectId");

                    b.HasIndex("TeachersSubjectsSubjectId");
            ...
            modelBuilder.Entity("SubjectTeacher", b =>
                {
                    ...
                    b.HasOne("EFMVC.Models.Subject", null)
                        .WithMany()
                        .HasForeignKey("TeachersSubjectsSubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
